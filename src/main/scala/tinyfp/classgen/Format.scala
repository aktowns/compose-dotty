...
enum Instruction(val opcode: Byte):
  case AALoad                                            extends Instruction(0x32.toByte)
  case AAStore                                           extends Instruction(0x53.toByte)
  case AConstNull                                        extends Instruction(0x01.toByte)
  case ALoad(id1: Byte)                                  extends Instruction(0x19.toByte)
  case ALoad0                                            extends Instruction(0x2a.toByte)
  case ALoad1                                            extends Instruction(0x2b.toByte)
  case ALoad2                                            extends Instruction(0x2c.toByte)
  case ALoad3                                            extends Instruction(0x2d.toByte)
  case ANewArray(id1: Byte, id2: Byte)                   extends Instruction(0xbd.toByte)
  case AReturn                                           extends Instruction(0xb0.toByte)
  case ArrayLength                                       extends Instruction(0xbe.toByte)
  case AStore(id1: Byte)                                 extends Instruction(0x3a.toByte)
  case AStore0                                           extends Instruction(0x4b.toByte)
  case AStore1                                           extends Instruction(0x4c.toByte)
  case AStore2                                           extends Instruction(0x4d.toByte)
  case AStore3                                           extends Instruction(0x4e.toByte)
  case AThrow                                            extends Instruction(0xbf.toByte)
  case BALoad                                            extends Instruction(0x33.toByte)
  case BAStore                                           extends Instruction(0x54.toByte)
  case BIPush(byte: Byte)                                extends Instruction(0x10.toByte)
  case CALoad                                            extends Instruction(0x34.toByte)
  case CAStore                                           extends Instruction(0x55.toByte)
  case CheckCast(id1: Byte, id2: Byte)                   extends Instruction(0xc0.toByte)
  case D2F                                               extends Instruction(0x90.toByte)
  case D2I                                               extends Instruction(0x8e.toByte)
  case D2L                                               extends Instruction(0x8f.toByte)
  case DADD                                              extends Instruction(0x63.toByte)
  case DALoad                                            extends Instruction(0x31.toByte)
  case DAStore                                           extends Instruction(0x52.toByte)
  case DCmpG                                             extends Instruction(0x98.toByte)
  case DCmpL                                             extends Instruction(0x97.toByte)
  case DConst0                                           extends Instruction(0xe.toByte)
  case DConst1                                           extends Instruction(0xf.toByte)
  case DDiv                                              extends Instruction(0x6f.toByte)
  case DLoad(id1: Byte)                                  extends Instruction(0x18.toByte)
  case DLoad0                                            extends Instruction(0x26.toByte)
  case DLoad1                                            extends Instruction(0x27.toByte)
  case DLoad2                                            extends Instruction(0x28.toByte)
  case DLoad3                                            extends Instruction(0x29.toByte)
  case DMul                                              extends Instruction(0x6b.toByte)
  case DNeg                                              extends Instruction(0x77.toByte)
  case DRem                                              extends Instruction(0x73.toByte)
  case DReturn                                           extends Instruction(0xaf.toByte)
  case DStore(id1: Byte)                                 extends Instruction(0x39.toByte)
  case DStore0                                           extends Instruction(0x47.toByte)
  case DStore1                                           extends Instruction(0x48.toByte)
  case DStore2                                           extends Instruction(0x49.toByte)
  case DStore3                                           extends Instruction(0x4a.toByte)
  case DSub                                              extends Instruction(0x67.toByte)
  case Dup                                               extends Instruction(0x59.toByte)
  case DupX1                                             extends Instruction(0x5a.toByte)
  case DupX2                                             extends Instruction(0x5b.toByte)
  case Dup2                                              extends Instruction(0x5c.toByte)
  case Dup2X1                                            extends Instruction(0x5d.toByte)
  case Dup2X2                                            extends Instruction(0x5e.toByte)
  case F2D                                               extends Instruction(0x8d.toByte)
  case F2I                                               extends Instruction(0x8b.toByte)
  case F2L                                               extends Instruction(0x8c.toByte)
  case FAdd                                              extends Instruction(0x62.toByte)
  case FALoad                                            extends Instruction(0x30.toByte)
  case FAStore                                           extends Instruction(0x51.toByte)
  case FCmpG                                             extends Instruction(0x96.toByte)
  case FCmpL                                             extends Instruction(0x95.toByte)
  case FConst0                                           extends Instruction(0xb.toByte)
  case FConst1                                           extends Instruction(0xc.toByte)
  case FConst2                                           extends Instruction(0xd.toByte)
  case FDiv                                              extends Instruction(0x6e.toByte)
  case FLoad(id1: Byte)                                  extends Instruction(0x17.toByte)
  case FLoad0                                            extends Instruction(0x22.toByte)
  case FLoad1                                            extends Instruction(0x23.toByte)
  case FLoad2                                            extends Instruction(0x24.toByte)
  case FLoad3                                            extends Instruction(0x25.toByte)
  case FMul                                              extends Instruction(0x6a.toByte)
  case FNeg                                              extends Instruction(0x76.toByte)
  case FRem                                              extends Instruction(0x72.toByte)
  case FReturn                                           extends Instruction(0xae.toByte)
  case FStore(id1: Byte)                                 extends Instruction(0x38.toByte)
  case FStore0                                           extends Instruction(0x43.toByte)
  case FStore1                                           extends Instruction(0x44.toByte)
  case FStore2                                           extends Instruction(0x45.toByte)
  case FStore3                                           extends Instruction(0x46.toByte)
  case FSub                                              extends Instruction(0x66.toByte)
  case GetField(id1: Byte, id2: Byte)                    extends Instruction(0xb4.toByte)
  case GetStatic(id1: Byte, id2: Byte)                   extends Instruction(0xb2.toByte)
  case Goto(bb1: Byte, bb2: Byte)                        extends Instruction(0xa7.toByte)
  case GotoW(bb1: Byte, bb2: Byte, bb3: Byte, bb4: Byte) extends Instruction(0xc8.toByte)
  case I2B                                               extends Instruction(0x91.toByte)
  case I2C                                               extends Instruction(0x92.toByte)
  case I2D                                               extends Instruction(0x87.toByte)
  case I2F                                               extends Instruction(0x86.toByte)
  case I2L                                               extends Instruction(0x85.toByte)
  case I2S                                               extends Instruction(0x93.toByte)
  case IAdd                                              extends Instruction(0x60.toByte)
  case IALoad                                            extends Instruction(0x2e.toByte)
  case IAnd                                              extends Instruction(0x7e.toByte)
  case IAStore                                           extends Instruction(0x4f.toByte)
  case IConstM1                                          extends Instruction(0x2.toByte)
  case IConst0                                           extends Instruction(0x3.toByte)
  case IConst1                                           extends Instruction(0x4.toByte)
  case IConst2                                           extends Instruction(0x5.toByte)
  case IConst3                                           extends Instruction(0x6.toByte)
  case IConst4                                           extends Instruction(0x7.toByte)
  case IConst5                                           extends Instruction(0x8.toByte)
  case IDiv                                              extends Instruction(0x6c.toByte)
  case IfACmpEq(bb1: Byte, bb2: Byte)                    extends Instruction(0xa5.toByte)
  case IfACmpNe(bb1: Byte, bb2: Byte)                    extends Instruction(0xa6.toByte)
  case IfICmpEq(bb1: Byte, bb2: Byte)                    extends Instruction(0x9f.toByte)
  case IfICmpNe(bb1: Byte, bb2: Byte)                    extends Instruction(0xa0.toByte)
  case IfICmpLt(bb1: Byte, bb2: Byte)                    extends Instruction(0xa1.toByte)
  case IfICmpGe(bb1: Byte, bb2: Byte)                    extends Instruction(0xa2.toByte)
  case IfICmpGt(bb1: Byte, bb2: Byte)                    extends Instruction(0xa3.toByte)
  case IfICmpLe(bb1: Byte, bb2: Byte)                    extends Instruction(0xa4.toByte)
  case IfEq(bb1: Byte, bb2: Byte)                        extends Instruction(0x99.toByte)
  case IfNe(bb1: Byte, bb2: Byte)                        extends Instruction(0x9a.toByte)
  case IfLt(bb1: Byte, bb2: Byte)                        extends Instruction(0x9b.toByte)
  case IfGe(bb1: Byte, bb2: Byte)                        extends Instruction(0x9c.toByte)
  case IfGt(bb1: Byte, bb2: Byte)                        extends Instruction(0x9d.toByte)
  case IfLe(bb1: Byte, bb2: Byte)                        extends Instruction(0x9e.toByte)
  case IfNonNull(bb1: Byte, bb2: Byte)                   extends Instruction(0xc7.toByte)
  case IfNull(bb1: Byte, bb2: Byte)                      extends Instruction(0xc6.toByte)
